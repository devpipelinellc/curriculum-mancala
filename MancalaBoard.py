...
class MancalaBoard:
    ...
    # ╚═══════════════════════════════════════════════════╝
    #                                         Player 2:
    def __init__(self, starting_stones=4, player_num=1, init_board=None, moves_list=None):
        if init_board:
    ...
    def reset(self):
        self.board = [0] + [self.starting_stones]*6 + [0] + [self.starting_stones]*6
        self.__moves = [[], []]
        self.player_1 = ''
        self.player_2 = ''

    def set_starting_stones(self, starting_stones):
        self.starting_stones = starting_stones
...
'''
    ...
    def clone(self):
        return MancalaBoard(self.starting_stones, self.player_num, self.board.copy(), deep_copy_list(self.__moves))
